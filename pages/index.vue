...
<section class="text-gray-600 body-font">
  <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    ...
    <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
      <img class="object-cover object-center rounded" alt="hero" src="compassfull.jpeg">
    </div>
  </div>
</section>

<section class="text-gray-600 body-font overflow-hidden" id="course">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      <h1 class="sm:text-4xl text-3xl font-medium title-font mb-2 text-gray-900">Our Programmes</h1>
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base text-gray-500">Help students to build the foundation of their future success by helping them to become independent learners.</p>
    </div>
    <div class="flex flex-wrap -m-4">
    
    <!-- 10th Std ( State Syllabus ) -->
     <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
        <div class="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
          <h2 class="text-sm tracking-widest title-font mb-1 font-medium">State Syllabus</h2>
          <h3 class="text-5xl text-gray-900 pb-4 mb-4 border-b border-gray-200 leading-none">10th Std</h3>
          ...
          <p class="flex items-center text-gray-600 mb-6">
            ...
            </span>Malayalam/Hindi
          </p>

          <p class="text-gray-500 mt-3">Free study materials will be provided.</p>
        </div>
      </div>

      <!-- 10th Std ( CBSE Syllabus ) -->
    <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
        <div class="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
          <h2 class="text-sm tracking-widest title-font mb-1 font-medium">CBSE Syllabus</h2>
          <h3 class="text-5xl text-gray-900 pb-4 mb-4 border-b border-gray-200 leading-none">10th Std</h3>
     ...
     <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
        <div class="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
           <h2 class="text-sm tracking-widest title-font mb-1 font-medium">Science</h2>
          <h1 class="text-5xl text-gray-900 pb-4 mb-4 border-b border-gray-200 leading-none">11th Std</h1>
                    <p class="flex items-center text-gray-600 mb-2">
            <span class="w-4 h-4 mr-2 inline-flex items-center justify-center bg-indigo-500 text-white rounded-full flex-shrink-0">
              <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" class="w-3 h-3" viewBox="0 0 24 24">
                <path d="M20 6L9 17l-5-5"></path>
          ...
          <p class="flex items-center text-gray-600 mb-6">
            ...
            <p class="text-gray-500 mt-3">Special coaching for students who had studied in malayalam medium schools till 10th std.</p>
            <p class="text-gray-500 mt-3">Free study materials will be provided.</p>
            <p class="text-gray-500 mt-3">Entrance oriented special classes.</p>
        </div>
      </div>
     ...
     <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
        <div class="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
           <h2 class="text-sm tracking-widest title-font mb-1 font-medium">Commerce</h2>
          <h1 class="text-5xl text-gray-900 pb-4 mb-4 border-b border-gray-200 leading-none">11th Std</h1>
                    <p class="flex items-center text-gray-600 mb-2">
            <span class="w-4 h-4 mr-2 inline-flex items-center justify-center bg-indigo-500 text-white rounded-full flex-shrink-0">
              <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" class="w-3 h-3" viewBox="0 0 24 24">
     ...
     <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
        <div class="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
           <h2 class="text-sm tracking-widest title-font mb-1 font-medium">Science</h2>
          <h1 class="text-5xl text-gray-900 pb-4 mb-4 border-b border-gray-200 leading-none">12th Std</h1>
                    <p class="flex items-center text-gray-600 mb-2">
            <span class="w-4 h-4 mr-2 inline-flex items-center justify-center bg-indigo-500 text-white rounded-full flex-shrink-0">
              <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" class="w-3 h-3" viewBox="0 0 24 24">
                <path d="M20 6L9 17l-5-5"></path>
  ...
  <div class="container px-5 py-24 mx-auto flex flex-wrap">
    ...
    <div class="flex flex-wrap md:-m-2 -m-1">
      ...
      <div class="flex flex-wrap w-full">
        <div class="md:p-2 p-1 w-1/2"  v-for="(image, imageIndex) in items"
        :key="imageIndex"
        @click="index = imageIndex"
        >
          <img alt="gallery" class="w-full object-cover  object-center block" :src=" image  ">
        </div>
      </div>
    </div>
  </div>
